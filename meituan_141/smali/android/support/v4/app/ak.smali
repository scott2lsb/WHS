...
.method public onCreatePanelMenu(ILcom/actionbarsherlock/view/Menu;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/app/ak;->onCreateOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z

    move-result v6

    invoke-virtual {p0}, Landroid/support/v4/app/ak;->getSupportMenuInflater()Lcom/actionbarsherlock/view/MenuInflater;

    move-result-object v7

    const/4 v2, 0x0

    iget-object v0, p0, Landroid/support/v4/app/ak;->mFragments:Landroid/support/v4/app/n;
    ...
    instance-of v3, v0, Landroid/support/v4/app/al;
    ...
    check-cast v1, Landroid/support/v4/app/al;

    invoke-interface {v1, p2, v7}, Landroid/support/v4/app/al;->onCreateOptionsMenu(Lcom/actionbarsherlock/view/Menu;Lcom/actionbarsherlock/view/MenuInflater;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/ak;->mCreatedMenus:Ljava/util/ArrayList;
    ...
    :cond_4
    iput-object v2, p0, Landroid/support/v4/app/ak;->mCreatedMenus:Ljava/util/ArrayList;
...
.method public onMenuItemSelected(ILcom/actionbarsherlock/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/app/ak;->onOptionsItemSelected(Lcom/actionbarsherlock/view/MenuItem;)Z
    ...
    instance-of v4, v0, Landroid/support/v4/app/am;

    if-eqz v4, :cond_2

    check-cast v0, Landroid/support/v4/app/am;

    invoke-interface {v0, p2}, Landroid/support/v4/app/am;->onOptionsItemSelected(Lcom/actionbarsherlock/view/MenuItem;)Z
...
.method public onPreparePanel(ILandroid/view/View;Lcom/actionbarsherlock/view/Menu;)Z
    ...
    invoke-virtual {p0, p3}, Landroid/support/v4/app/ak;->onPrepareOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z

    move-result v3

    iget-object v1, p0, Landroid/support/v4/app/ak;->mFragments:Landroid/support/v4/app/n;
    ...
    instance-of v4, v0, Landroid/support/v4/app/an;
    ...
    invoke-interface {v0, p3}, Landroid/support/v4/app/an;->onPrepareOptionsMenu(Lcom/actionbarsherlock/view/Menu;)V
