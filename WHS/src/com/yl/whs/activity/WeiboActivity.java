    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (mAccessToken.isSessionValid()) {
                ...
                Toast.makeText(WeiboActivity.this, "微博授权成功", Toast.LENGTH_SHORT).show();
            } else {
                // 以下几种情况，您会收到 Code：
                ...
                Toast.makeText(WeiboActivity.this, "微博授权失败", Toast.LENGTH_SHORT).show();
            }
        }

        @Override
        public void onCancel() {
            Toast.makeText(WeiboActivity.this, "取消微博授权", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onWeiboException(WeiboException e) {
            Toast.makeText(WeiboActivity.this, "微博授权异常", Toast.LENGTH_SHORT).show();
        }
    }
}
