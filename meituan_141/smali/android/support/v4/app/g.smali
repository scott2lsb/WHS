...
# instance fields
.field mAllLoaderManagers:Landroid/support/v4/c/l;
...
.field final mContainer:Landroid/support/v4/app/l;
...
.field mLoaderManager:Landroid/support/v4/app/ac;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/g;->mHandler:Landroid/os/Handler;

    new-instance v0, Landroid/support/v4/app/n;

    invoke-direct {v0}, Landroid/support/v4/app/n;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/g;->mFragments:Landroid/support/v4/app/n;

    new-instance v0, Landroid/support/v4/app/i;

    invoke-direct {v0, p0}, Landroid/support/v4/app/i;-><init>(Landroid/support/v4/app/g;)V

    iput-object v0, p0, Landroid/support/v4/app/g;->mContainer:Landroid/support/v4/app/l;
...
.method private dumpViewHierarchy(Ljava/lang/String;Ljava/io/PrintWriter;Landroid/view/View;)V
    ...
    :cond_1
    invoke-static {p3}, Landroid/support/v4/app/g;->viewToString(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, p2, v3}, Landroid/support/v4/app/g;->dumpViewHierarchy(Ljava/lang/String;Ljava/io/PrintWriter;Landroid/view/View;)V
...
.method doReallyStop(Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mReallyStopped:Z

    if-nez v0, :cond_0

    iput-boolean v1, p0, Landroid/support/v4/app/g;->mReallyStopped:Z

    iput-boolean p1, p0, Landroid/support/v4/app/g;->mRetaining:Z

    iget-object v0, p0, Landroid/support/v4/app/g;->mHandler:Landroid/os/Handler;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {p0}, Landroid/support/v4/app/g;->onReallyStop()V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/g;->mCreated:Z
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/g;->mResumed:Z
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/g;->mStopped:Z
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/g;->mReallyStopped:Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mLoadersStarted:Z

    invoke-virtual {p3, v0}, Ljava/io/PrintWriter;->println(Z)V

    iget-object v0, p0, Landroid/support/v4/app/g;->mLoaderManager:Landroid/support/v4/app/ac;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/g;->mFragments:Landroid/support/v4/app/n;
    ...
    invoke-direct {p0, v0, p3, v1}, Landroid/support/v4/app/g;->dumpViewHierarchy(Ljava/lang/String;Ljava/io/PrintWriter;Landroid/view/View;)V
...
.method public getLastCustomNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/v4/app/k;->b:Ljava/lang/Object;
...
.method getLoaderManager(Ljava/lang/String;ZZ)Landroid/support/v4/app/ac;
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;
    ...
    iput-object v0, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/ac;-><init>(Ljava/lang/String;Landroid/support/v4/app/g;Z)V

    iget-object v1, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;
    ...
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/app/ac;->a(Landroid/support/v4/app/g;)V
...
.method public getSupportLoaderManager()Landroid/support/v4/app/aa;
    .locals 3
    ...
    :cond_0
    iput-boolean v2, p0, Landroid/support/v4/app/g;->mCheckedForLoaderManager:Z

    const-string v0, "(root)"

    iget-boolean v1, p0, Landroid/support/v4/app/g;->mLoadersStarted:Z

    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/g;->getLoaderManager(Ljava/lang/String;ZZ)Landroid/support/v4/app/ac;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/g;->mLoaderManager:Landroid/support/v4/app/ac;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/g;->mFragments:Landroid/support/v4/app/n;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/g;->mContainer:Landroid/support/v4/app/l;

    invoke-virtual {v0, p0, v2, v1}, Landroid/support/v4/app/n;->a(Landroid/support/v4/app/g;Landroid/support/v4/app/l;Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v2, v0, Landroid/support/v4/app/k;->e:Landroid/support/v4/c/l;

    iput-object v2, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;
    ...
    iget-object v3, p0, Landroid/support/v4/app/g;->mFragments:Landroid/support/v4/app/n;
    ...
    :goto_0
    invoke-virtual {v3, v2, v0}, Landroid/support/v4/app/n;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iput-object v1, v4, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/n;
...
.method public onDestroy()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/g;->doReallyStop(Z)V
...
.method public onPause()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/g;->mResumed:Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/g;->onResumeFragments()V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mOptionsMenuInvalidated:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v4/app/g;->mOptionsMenuInvalidated:Z
    ...
    :cond_0
    invoke-virtual {p0, p2, p3}, Landroid/support/v4/app/g;->onPrepareOptionsPanel(Landroid/view/View;Landroid/view/Menu;)Z
...
.method onReallyStop()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/g;->mLoadersStarted:Z

    iget-object v0, p0, Landroid/support/v4/app/g;->mLoaderManager:Landroid/support/v4/app/ac;

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v4/app/g;->mRetaining:Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mStopped:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0, v1}, Landroid/support/v4/app/g;->doReallyStop(Z)V

    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/g;->onRetainCustomNonConfigurationInstance()Ljava/lang/Object;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/c/l;->b(I)Ljava/lang/Object;
    ...
    iget-object v9, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;
    ...
    iput-object v2, v0, Landroid/support/v4/app/k;->c:Landroid/support/v4/c/l;

    iput-object v6, v0, Landroid/support/v4/app/k;->d:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/g;->mAllLoaderManagers:Landroid/support/v4/c/l;

    iput-object v1, v0, Landroid/support/v4/app/k;->e:Landroid/support/v4/c/l;
...
.method public onStart()V
    ...
    iput-boolean v1, p0, Landroid/support/v4/app/g;->mStopped:Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mCreated:Z

    if-nez v0, :cond_0

    iput-boolean v3, p0, Landroid/support/v4/app/g;->mCreated:Z
    ...
    iput-boolean v3, p0, Landroid/support/v4/app/g;->mLoadersStarted:Z
    ...
    :cond_1
    :goto_0
    iput-boolean v3, p0, Landroid/support/v4/app/g;->mCheckedForLoaderManager:Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/c/l;->b(I)Ljava/lang/Object;
    ...
    :cond_3
    iget-boolean v0, p0, Landroid/support/v4/app/g;->mCheckedForLoaderManager:Z

    if-nez v0, :cond_1

    const-string v0, "(root)"

    iget-boolean v2, p0, Landroid/support/v4/app/g;->mLoadersStarted:Z

    invoke-virtual {p0, v0, v2, v1}, Landroid/support/v4/app/g;->getLoaderManager(Ljava/lang/String;ZZ)Landroid/support/v4/app/ac;
